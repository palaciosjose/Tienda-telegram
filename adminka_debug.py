...
print(f"🔧 DEBUG_ADMINKA: in_adminka() llamado con chat_id={chat_id}, message_text='{message_text}'")
    print(f"🔧 DEBUG_ADMINKA: Usuario es admin: {chat_id in dop.get_adminlist()}")
